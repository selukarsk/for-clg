...
class Face_Recognition_System:
    def __init__(self,root):
       ...
       # first img
        ...
        #third img
        img3=Image.open(r"college_images\u.jpg")
        ...
        #bg img
        img4=Image.open(r"college_images\wp2551980.jpg")
        ...
        lbl.place(x=5,y=2,width=110,height=50)
        time()
        ...
        b1_1=Button(bg_img,text="Attendence",cursor="hand2",command=self.attendance,font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        ...
        # photos button
        img10=Image.open(r"college_images\photo.jpg")
